...
public class MappingFileReader extends DefaultHandler {
    ...
    /** The element mappers. */
    private Map<String, ElementMapper<Locateable>> elementMappers;
    ...
    public MappingFileReader(final SAXParser parserParam,
                             final Map<String, ElementMapper<Locateable>> elementMappersParam)
            throws IOException {
        super();
    ...
    private void addFieldDescription(final Attributes attributes) {
        ElementMapper<Locateable> fieldMapper;
        fieldMapper = elementMappers.get(FIELD);
        currentFieldDescription = (FieldDescription) fieldMapper.mapElement(attributes);
    ...
    private void addAnnotationsDescription(final Attributes attributes) {
        ElementMapper<Locateable> annotationsMapper;
        annotationsMapper = elementMappers.get(ANNOTATIONS);
        currentAnnotationsDescription = (AnnotationsDescription) annotationsMapper
    ...
    private void addAnnotationDescription(final Attributes attributes) {
        ElementMapper<Locateable> annotationMapper;
        annotationMapper = elementMappers.get(ANNOTATION);
        AnnotationDescription annotationDescription = (AnnotationDescription) annotationMapper
                .mapElement(attributes);
    ...
    private void addFeaturesDescription(final Attributes attributes) {
        ElementMapper<Locateable> featuresMapper;
        featuresMapper = elementMappers.get(FEATURES);
        FeaturesDescription featuresDescription = (FeaturesDescription) featuresMapper
                                                    .mapElement(attributes);
    ...
    private void addFeatureDescription(final Attributes attributes) {
        ElementMapper<Locateable> featureMapper;
        featureMapper = elementMappers.get(FEATURE);
        FeatureDescription featureDescription = (FeatureDescription) featureMapper
                .mapElement(attributes);
